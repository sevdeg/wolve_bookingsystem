<template>
    <div class="flex md4" id="leftDiv">
        ...
        <!-- <va-card-title>Velg behandling, fortell litt type info du vil vise</va-card-title> -->
            <va-card-content>Velg din behandling</va-card-content><br>
            <va-card-content>Her kan du velge den behandlingen som passer deg best</va-card-content><br><br><br><br><br>
