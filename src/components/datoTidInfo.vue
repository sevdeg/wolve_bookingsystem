<template>
    <div class="flex md4" id="leftDiv">
        ...
        <va-card-content>BILDE 3</va-card-content> <br>
        <va-card-content>Velg dato og tid</va-card-content>
        <va-card-content>Her kan du velge den tiden som passer deg best</va-card-content><br>
