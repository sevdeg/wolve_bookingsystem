<template>
    <div class="flex md4" id="leftDiv">
        ...
        <va-card-content>Skriv inn kundeinformasjon</va-card-content><br>
        <va-card-content>Skriv inn dine kontakt informasjon, slik at vi kan kontakte deg</va-card-content><br><br><br><br><br>
